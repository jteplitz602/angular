...
import {EVENT_CHANNEL} from 'angular2_worker/src/shared/messaging_api';
...
export function main() {
  describe("EventDispatcher", () => {
    ...
    it("should dispatch events", inject([Injector, AsyncTestCompleter], (injector, async) => {
         var serializer = createSerializer(injector);
