...
import {createSerializer} from '../shared/web_worker_test_util';
import {DomTestbed, TestRootView, elRef} from './dom_testbed';
import {WebWorkerCompiler, WebWorkerRenderer} from "angular2_worker/src/worker/renderer";
import {
  ClientMessageBrokerFactory,
  UiArguments,
  FnArg
} from "angular2_worker/src/shared/client_message_broker";
...
} from "angular2_worker/src/shared/render_proto_view_ref_store";
import {
...
import {WebWorkerApplication} from 'angular2_worker/src/ui/impl';
import {MessageBasedRenderCompiler} from 'angular2_worker/src/ui/render_compiler';
import {MessageBasedRenderer} from 'angular2_worker/src/ui/renderer';
import {createPairedMessageBuses} from '../shared/web_worker_test_util';
import {ServiceMessageBrokerFactory} from 'angular2_worker/src/shared/service_message_broker';
...
export function main() {
  ...
  describe("Web Worker Compiler", function() {
    ...
    beforeEach(inject([Injector, DomTestbed], (injector, testBed) => {
      ...
      workerSerializer = createSerializer(injector, workerRenderProtoViewRefStore, null);
      uiSerializer = createSerializer(injector, uiRenderProtoViewRefStore, null);
  ...
  describe("Web Worker Renderer", () => {
    ...
    beforeEach(inject([Injector, DomTestbed], (injector, testBed) => {
      ...
      workerSerializer =
          createSerializer(injector, new RenderProtoViewRefStore(true), workerRenderViewStore);
      uiSerializer =
          createSerializer(injector, new RenderProtoViewRefStore(false), uiRenderViewStore);
