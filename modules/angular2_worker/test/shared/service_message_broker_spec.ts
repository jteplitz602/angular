...
import {ServiceMessageBroker} from 'angular2_worker/src/shared/service_message_broker';
...
export function main() {
  ...
  describe("UIMessageBroker", () => {
    ...
    it("should return promises to the worker",
       () => {
         var broker = new ServiceMessageBroker(messageBuses.ui, serializer, CHANNEL);
