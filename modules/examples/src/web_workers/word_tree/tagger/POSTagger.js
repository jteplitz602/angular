...
String.prototype.startsWith =
  ...
  return this.indexOf(string) == this.length - string.length;
        ...
        POSTagger.prototype.wordInLexicon =
            function(word) {
...
**/
  for (var i = 0; i < words.length; i++) {
    ...
    if (i > 0 && ret[i].startsWith("NN") && words[i - 1].toLowerCase() == "would") ret[i] = "VB";
  ...
  return result;
                ...
                POSTagger.prototype.prettyPrint =
                    function(taggedWords) {
  for (i in taggedWords) {
    print(taggedWords[i][0] + "(" + taggedWords[i][1] + ")");
  }
}

// print(new POSTagger().tag(["i", "went", "to", "the", "store", "to", "buy", "5.2", "gallons",
// "of", "milk"]));