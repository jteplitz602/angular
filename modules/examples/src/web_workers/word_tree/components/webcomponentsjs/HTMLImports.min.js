...
"undefined" == typeof WeakMap &&
    ...
    function(e) {
      function t(e) { w.push(e), _ || (_ = !0, f(r)) }
      function n(e) {
      ...
      function c(e, t) { return L = new s(e, t) }
      function u(e) { return y ? y : (y = d(L), y.oldValue = e, y) }
      function l() { L = y = void 0 }
      function h(e) { return e === y || e === L }
      function m(e, t) { return e === t ? e : y && h(e) ? y : null }
      function p(e, t, n) {
      ...
      if (/Trident|Edge/.test(navigator.userAgent))
        ...
        window.addEventListener("message", function(e) {
          if (e.data === g) {
            var t = b;
            b = [], t.forEach(function(e) { e() })
          }
        }), f = function(e) { b.push(e), window.postMessage(g, "*") }
      }
      var _ = !1, w = [], E = 0;
      a.prototype = {
            ...
            handleEvent: function(e) {
              switch (e.stopImmediatePropagation(), e.type) {
                ...
                case "DOMNodeInserted":
                  ...
                  var m = h.previousSibling, p = h.nextSibling,
                      o = c("childList", e.target.parentNode);
                  o.addedNodes = s, o.removedNodes = d, o.previousSibling = m, o.nextSibling = p,
  ...
  function(e) {
    function t(e, t) {
      t = t || p, r(function() { i(e, t) }, t)
    }
    function n(e) { return "complete" === e.readyState || e.readyState === b }
    function r(e, t) {
      if (n(t))
        e && e();
      else {
        var o = function() {
          ("complete" === t.readyState || t.readyState === b) &&
    ...
    function i(e, t) {
      function n() { d == c && e && e({allImports: s, loadedImports: u, errorImports: l}) }
      function r(e) { o(e), u.push(this), d++, n() }
      function i(e) { l.push(this), d++, n() }
      var s = t.querySelectorAll("link[rel=import]"), d = 0, c = s.length, u = [], l = [];
      if (c)
        for (var h, m = 0; c > m && (h = s[m]); m++)
          a(h) ? (d++, n()) : (h.addEventListener("load", r), h.addEventListener("error", i));
      else
        n()
    }
    function a(e) {
    ...
    function d(e) { return "link" === e.localName && "import" === e.rel }
    function c(e) {
      var t = e["import"];
    ...
    var u = "import", l = Boolean(u in document.createElement("link")),
        ...
        m = function(e) { return h ? window.ShadowDOMPolyfill.wrapIfNeeded(e) : e },
        p = m(document), f = {
          get: function() {
    ...
    var v = /Trident/.test(navigator.userAgent), b = v ? "complete" : "interactive",
        g = "readystatechange";
  ...
  window.HTMLImports.addModule(function(e) {
    ...
    var a = e.path, s = e.rootDocument, d = e.flags, c = e.isIE, u = e.IMPORT_LINK_TYPE,
        l = "link[rel=" + u + "]", h = {
          documentSelectors: l,
          importsSelectors: [
            l,
          ...
          markParsingComplete: function(e) {
            ...
            this.parsingElement = null, d.parse && console.log("completed", e)
          },
          ...
          trackElement: function(e, t) {
            ...
            if (e.addEventListener("load", r), e.addEventListener("error", r),
              ...
              if (-1 == e.textContent.indexOf("@import"))
                ...
                o = !0;
                for (var i, a = e.sheet.cssRules, s = a ? a.length : 0, d = 0; s > d && (i = a[d]);
                     d++)
  ...
  window.HTMLImports.addModule(function(e) {
    ...
    var i = e.flags, a = e.IMPORT_LINK_TYPE, s = e.IMPORT_SELECTOR, d = e.rootDocument,
        c = e.Loader, u = e.Observer, l = e.parser,
        h =
            {
              documents: {},
              documentPreloadSelectors: s,
              importsPreloadSelectors: [s].join(","),
              loadNode: function(e) { m.addNode(e) },
              ...
              loaded: function(e, n, r, a, s) {
                if (i.load && console.log("loaded", e, n), n.__resource = r, n.__error = a, t(n)) {
                  ...
                  void 0 === d &&
                      (d = a ? null : o(r, s || e), d && (d.__importLink = n, this.bootDocument(d)),
                       this.documents[e] = d),
                      n.__doc = d
                }
                l.parseNext()
