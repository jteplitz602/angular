...
"undefined" == typeof WeakMap &&
      ...
      n.prototype =
          {
            set: function(t, n) {
              var o = t[this.name];
              return o && o[0] === t ? o[1] = n : e(t, this.name, {value: [t, n], writable: !0}),
                                       this
            },
            get: function(e) {
              var t;
    ...
    function(e) {
      function t(e) { _.push(e), b || (b = !0, h(o)) }
      function n(e) {
      ...
      function o() {
        b = !1;
        var e = _;
        _ = [], e.sort(function(e, t) { return e.uid_ - t.uid_ });
        var t = !1;
      ...
      function u(e, t) { return y = new d(e, t) }
      function c(e) { return N ? N : (N = s(y), N.oldValue = e, N) }
      function l() { y = N = void 0 }
      function f(e) { return e === N || e === y }
      function p(e, t) { return e === t ? e : N && f(e) ? N : null }
      function m(e, t, n) {
      ...
      if (/Trident|Edge/.test(navigator.userAgent))
        ...
        }), h = function(e) { v.push(e), window.postMessage(g, "*") }
      }
      var b = !1, _ = [], E = 0;
      a.prototype = {
            ...
            handleEvent: function(e) {
              switch (e.stopImmediatePropagation(), e.type) {
                ...
                case "DOMNodeInserted":
                  ...
                  var p = f.previousSibling, m = f.nextSibling,
                      r = u("childList", e.target.parentNode);
                  r.addedNodes = d, r.removedNodes = s, r.previousSibling = p, r.nextSibling = m,
                  i(e.relatedNode, function(e) { return e.childList ? r : void 0 })
              }
              l()
            }
          },
  ...
  function(e) {
    var t = e.flags, n = [], o = function(e) { n.push(e) },
        r = function() { n.forEach(function(t) { t(e) }) };
  ...
  window.CustomElements.addModule(function(e) {
    function t(e, t) {
      n(e, function(e) { return t(e) ? !0 : void o(e, t) }), o(e, t)
    }
    function n(e, t, o) {
  ...
  window.CustomElements.addModule(function(e) {
    ...
    function s(e) {
      u(e), b(e, function(e) { u(e) })
    }
    function u(e) {
      E ? r(function() { c(e) }) : c(e)
    }
    function c(e) {
      e.__upgraded__ && e.__attached &&
    ...
    function p(e, n) {
      ...
      n.forEach(function(e) {
        "childList" === e.type && (O(e.addedNodes, function(e) { e.localName && t(e, a) }),
                                   O(e.removedNodes, function(e) { e.localName && s(e) }))
      }),
    ...
    function v(e) { _(e, w) }
    var g = e.flags, b = e.forSubtree, _ = e.forDocumentTree,
        E = !window.MutationObserver || window.MutationObserver === window.JsMutationObserver;
    e.hasPolyfillMutations = E;
    var y = !1, N = [], O = Array.prototype.forEach.call.bind(Array.prototype.forEach),
    ...
    M && (Element.prototype.createShadowRoot =
        ...
        e.watchShadow = f, e.upgradeDocumentTree = v, e.upgradeDocument = w, e.upgradeSubtree = o,
        e.upgradeAll = t, e.attached = a, e.takeRecords = m
  }),
  window.CustomElements.addModule(function(e) {
    function t(t, o) {
    ...
    function n(t, n, r) {
      return a.upgrade && console.group("upgrade:", t.localName),
             n.is && t.setAttribute("is", n.is), o(t, n),
             t.__upgraded__ = !0, i(t), r && e.attached(t), e.upgradeSubtree(t, r),
  ...
  window.CustomElements.addModule(function(e) {
    function t(t, o) {
      ...
      return s.prototype || (s.prototype = Object.create(HTMLElement.prototype)),
             s.__name = t.toLowerCase(), s.lifecycle = s.lifecycle || {},
             s.ancestry = i(s["extends"]), a(s), d(s), n(s.prototype), c(s.__name, s),
             s.ctor = l(s), s.ctor.prototype = s.prototype, s.prototype.constructor = s.ctor,
             e.ready && v(document), s.ctor
    }
    function n(e) {
      if (!e.setAttribute._polyfilled) {
        ...
        e.removeAttribute = function(e) { o.call(this, e, null, n) },
    ...
    function s(e) { return b(M(e.tag), e) }
    function u(e) { return e ? N[e.toLowerCase()] : void 0 }
    function c(e, t) { N[e] = t }
    function l(e) {
      return function() { return s(e) }
    }
    function f(e, t, n) { return e === O ? p(t, n) : D(e, t) }
    function p(e, t) {
      ...
      var o;
      return t ? (o = p(e), o.setAttribute("is", t), o) :
                 (o = M(e), e.indexOf("-") >= 0 && _(o, HTMLElement), o)
    }
    function m(e, t) {
      var n = e[t];
      e[t] = function() {
    ...
    var h, w = e.isIE11OrOlder, v = e.upgradeDocumentTree, g = e.upgradeAll,
           b = e.upgradeWithDefinition, _ = e.implementPrototype, E = e.useNative,
           y =
               [
                 "annotation-xml",
                 "color-profile",
           ...
           N = {}, O = "http://www.w3.org/1999/xhtml", M = document.createElement.bind(document),
           D = document.createElementNS.bind(document);
    h = Object.__proto__ || E ? function(e, t) { return e instanceof t } :
                                function(e, t) {
    ...
    m(Node.prototype, "cloneNode"), m(document, "importNode"),
    w &&
        !function() {
    ...
    document.registerElement = t, document.createElement = p, document.createElementNS = f,
    e.registry = N, e["instanceof"] = h, e.reservedTagList = y, e.getRegisteredDefinition = u,
  ...
  function(e) {
    ...
    var n = e.useNative, o = e.initializeModules, r = /Trident/.test(navigator.userAgent);
    if (n) {
      var i = function() {};
      ...
      o();
    var a = e.upgradeDocumentTree, d = e.upgradeDocument;
    if (window.wrap ||
      ...
      var s = window.HTMLImports && !window.HTMLImports.ready ? "HTMLImportsLoaded" :
                                                                "DOMContentLoaded";
